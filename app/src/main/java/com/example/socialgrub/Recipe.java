...
public class Recipe {
    ...
    public Recipe(String ingredient1, String direction1, String tag1 ) {
    ...
    public Recipe(String ingredient1, String direction1, String tag1, String recipeTitle, String recipeDescription,
                  String recipeUrl) {
